...
class Vehiculo(models.Model):
    marca = models.CharField(max_length=20,verbose_name='Marca',choices=marcas)
    ...
    categoria = models.CharField(max_length=20,verbose_name_plural='Categoria',choices=categoria)
